    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCategoria.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intentCategoria = new Intent(PantallaPrincipal.this, MainActivity.class);
        ...
        btnEstadistica.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentEstadistic = new Intent(PantallaPrincipal.this, MainActivity.class);
        ...
        btnConsejo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentConsejo = new Intent(PantallaPrincipal.this, MainActivity.class);
